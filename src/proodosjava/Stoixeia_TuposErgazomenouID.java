...
public class Stoixeia_TuposErgazomenouID extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TUPOS ERGAZOMENOU ID");
        ...
        selectionBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ThesiID", "Onoma", " " }));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
              ...
              Statement stmt = (Statement) conn.createStatement();
                            String st = "SELECT ifnull(`stoixeia_thesi_ergazomenou_Type`.`thesiid`,0)," +
                                    "    ifnull(`stoixeia_thesi_ergazomenou_Type`.`onoma`,0)" +
                                    "FROM `proodos`.`stoixeia_thesi_ergazomenou_Type` "+
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "DELETE FROM `proodos`.`stoixeia_thesi_ergazomenou_Type`WHERE(`"+colName+"`='"+colValue+"');";
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
            ...
            try {
                ...
                String st = "INSERT INTO `proodos`.`stoixeia_thesi_ergazomenou_Type`(" + columnNames.toString() + ") VALUES (" + columnValues.toString() + ")";
    ...
    private void applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyActionPerformed
        ...
        String colValue=model.getValueAt(jTable2.getSelectedRow(), i).toString();
            try{
              ...
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "Update `proodos`.`stoixeia_thesi_ergazomenou_Type`SET`"+colName+"`='"+colValue+"' WHERE (`thesiid`='"+model.getValueAt(jTable2.getSelectedRow(), 0)+"')";
              stmt.executeUpdate(st);
              conn.close();
           }
           catch(SQLException e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stoixeia_TuposErgazomenouID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stoixeia_TuposErgazomenouID().setVisible(true);
            }
        });
    }
