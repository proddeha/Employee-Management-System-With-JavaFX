...
public class HmerominiaTyposApousias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TYPOS APOUSIAS");
        ...
        jButton6.setText("Proslipsi/Apolisi");
        ...
        selectionBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TyposApousiasID", "OnomasiaTypou" }));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
              ...
              Statement stmt = (Statement) conn.createStatement();
                            String st = "SELECT ifnull(`hmerominia_typos_apousias`.`TyposApousiasID`,0)," +
                                    "    ifnull(`hmerominia_typos_apousias`.`OnomasiaTypou`,0)" +
                                    "FROM `proodos`.`hmerominia_typos_apousias`"+
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "DELETE FROM `proodos`.`hmerominia_typos_apousias`WHERE(`"+colName+"`='"+colValue+"');";
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
            ...
            try {
                ...
                String st = "INSERT INTO `proodos`.`hmerominia__typos_apousias`(" + columnNames.toString() + ") VALUES (" + columnValues.toString() + ")";
    ...
    private void applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyActionPerformed
        ...
        String colValue=model.getValueAt(jTable2.getSelectedRow(), i).toString();
            ...
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "Update `proodos`.`hmerominia_typos_apousias`SET`"+colName+"`='"+colValue+"' WHERE (`"+idName+"`='"+model.getValueAt(jTable2.getSelectedRow(), 0)+"')";
              stmt.executeUpdate(st);
              conn.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HmerominiaTyposApousias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HmerominiaTyposApousias().setVisible(true);
            }
        });
    }
