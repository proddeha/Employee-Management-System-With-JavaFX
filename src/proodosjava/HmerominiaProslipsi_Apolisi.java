 ...
 * @author Kwstas
 */
public class HmerominiaProslipsi_Apolisi extends javax.swing.JFrame {
    private static String USERNAME = "root";
    private static String PASSWORD = "Helloimgosu1!";
    private static String CONN_STRING = "jdbc:mysql://localhost:3306/proodos";
    private static Object selectedOption;
    public HmerominiaProslipsi_Apolisi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ErgazomenosID", "HmerominiaProslipsis", "HmerominiaApolisis"
            }
        ));
        ...
        jLabel1.setText("PROSLIPSI/APOLISI");
        ...
        selectionBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ErgazomenosID", "HmerominiaProslipsis", "HmerominiaApolisis" }));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        selectedOption=selectionBox.getSelectedItem();
        ...
        try{
              ...
              Statement stmt = (Statement) conn.createStatement();
                            String st = "SELECT ifnull(`hmerominia_proslipsi/apolisi`.`ErgazomenosID`,0)," +
                                    "    ifnull(`hmerominia_proslipsi/apolisi`.`HmerominiaProslipsis`,0)," +
                                    "    ifnull(`hmerominia_proslipsi/apolisi`.`HmerominiaApolisis`,0)" +
                                    "FROM `proodos`.`hmerominia_proslipsi/apolisi` "+
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "DELETE FROM `proodos`.`hmerominia_proslipsi/apolisi`WHERE(`"+colName+"`='"+colValue+"');";
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
            ...
            try {
                ...
                String st = "INSERT INTO `proodos`.`hmerominia_proslipsi/apolisi`(" + columnNames.toString() + ") VALUES (" + columnValues.toString() + ")";
    ...
    private void applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyActionPerformed
        ...
        String colValue=model.getValueAt(jTable2.getSelectedRow(), i).toString();
            ...
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "Update `proodos`.`hmerominia_proslipsi/apolisi`SET`"+colName+"`='"+colValue+"' WHERE (`"+idName+"`='"+model.getValueAt(jTable2.getSelectedRow(), 0)+"')";
              stmt.executeUpdate(st);
              conn.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HmerominiaProslipsi_Apolisi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HmerominiaProslipsi_Apolisi().setVisible(true);
            }
        });
    }
