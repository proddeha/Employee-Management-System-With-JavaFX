...
public class Stoixeia_gamos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Tupos Ergazomenou ID");
        ...
        jLabel1.setText("STOIXEIA_GAMOS");
        ...
        selectionBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "StoixeiaGamosID", "Katastash", " " }));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
              ...
              Statement stmt = (Statement) conn.createStatement();
                            String st = "SELECT ifnull(`stoixeia_gamos`.`stoixeiagamosid`,0)," +
                                    "    ifnull(`stoixeia_gamos`.`katastash`,0)" +
                                    "FROM `proodos`.`stoixeia_gamos` "+
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "DELETE FROM `proodos`.`stoixeia_gamos`WHERE(`"+colName+"`='"+colValue+"');";
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        ...
        if (response==JOptionPane.YES_OPTION){
            try {
                ...
                String st = "INSERT INTO `proodos`.`stoixeia_gamos`(" + columnNames.toString() + ") VALUES (" + columnValues.toString() + ")";
    ...
    private void applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyActionPerformed
        ...
        String colValue=model.getValueAt(jTable2.getSelectedRow(), i).toString();
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "Update `proodos`.`stoixeia_gamos`SET`"+colName+"`='"+colValue+"' WHERE (`stoixeiagamosid`='"+model.getValueAt(jTable2.getSelectedRow(), 0)+"')";
              stmt.executeUpdate(st);
              conn.close();
           }
           catch(SQLException e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stoixeia_gamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stoixeia_gamos().setVisible(true);
            }
        });
    }
