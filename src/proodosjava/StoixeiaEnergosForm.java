...
public class StoixeiaEnergosForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ENERGOS / ANENERGOS");
        ...
        selectionBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ErgazomenosID", "Katastash", " " }));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(search, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(71, 71, 71)
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
              ...
              Statement stmt = (Statement) conn.createStatement();
                            String st = "SELECT ifnull(`stoixeia_energos/anenergos`.`ErgazomenosID`,0)," +
                                    "    ifnull(`stoixeia_energos/anenergos`.`Katastash`,0)" +
                                    "FROM `proodos`.`stoixeia_energos/anenergos` "+
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            try{
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "DELETE FROM `proodos`.`stoixeia_energos/anenergos`WHERE(`"+colName+"`='"+colValue+"');";
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
            ...
            try {
                ...
                String st = "INSERT INTO `proodos`.`stoixeia_energos/anenergos`(" + columnNames.toString() + ") VALUES (" + columnValues.toString() + ")";
    ...
    private void applyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyActionPerformed
        ...
        String colValue=model.getValueAt(jTable2.getSelectedRow(), i).toString();
            try{
              ...
              conn = DriverManager.getConnection(CONN_STRING,USERNAME,PASSWORD);
              Statement stmt = (Statement) conn.createStatement();
              String st = "Update `proodos`.`stoixeia_energos/anenergos`SET`"+colName+"`='"+colValue+"' WHERE (`"+idName+"`='"+model.getValueAt(jTable2.getSelectedRow(), 0)+"')";
              stmt.executeUpdate(st);
              conn.close();
           }
           catch(SQLException e)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StoixeiaEnergosForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StoixeiaEnergosForm().setVisible(true);
            }
        });
    }
